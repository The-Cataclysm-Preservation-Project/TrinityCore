...
-- Warsong Battleguard
UPDATE `creature` SET `unit_flags` = 33536 WHERE `guid` IN (110369,110370,110371,110378,110379,110380,110381,110382,110383,110384,110386,110389,110390) AND `id` = 25242;
...
--
UPDATE `creature` SET `unit_flags` = `unit_flags` &~ (536870912|262144) WHERE `id` IN (31098,31094,28610,28939,28940,28941,28942);
...
UPDATE `creature` SET `unit_flags` = 0 WHERE `guid` IN (48254,48256,48257,108311,108312,108315,108316,108317,108318) AND `id` = 27530;
...
INSERT INTO `creature_addon` (`guid`, `visibilityDistanceType`, `auras`) VALUES
(48254,3,'49132 55795 61204'),
(48256,3,'49132 55795 61204'),
(48257,3,'49132 55795 61204'),
(108311,3,'49132 55795 61204'),
(108312,3,'49132 55795 61204'),
(108315,3,'49132 55795 61204'),
(108316,3,'49132 55795 61204'),
(108317,3,'49132 55795 61204'),
(108318,3,'49132 55795 61204');
...
-- Vrykul Corpse
UPDATE `creature_template` SET `unit_flags` = `unit_flags` &~ (536870912|262144) WHERE `entry` = 24467;
UPDATE `creature_template_addon` SET  `auras` = '29266' WHERE `entry` = 24467;
...
-- Halfdan's Soul
UPDATE `creature_template_addon` SET `auras` = '37119 36545 36550' WHERE `entry` = 24119;
...
-- Scout Jyoba
UPDATE `creature_template` SET `unit_flags` = 768 WHERE `entry` = 18035;
UPDATE `creature_template_addon` SET `auras` = '29266' WHERE `entry` = 18035;

-- Blood Knight Dawnstar
-- Not sniffed but not really guessed
UPDATE `creature_template` SET `unit_flags` = 768 WHERE `entry` = 17832;
UPDATE `creature_template_addon` SET `auras` = '29266' WHERE `entry` = 17832;

-- Creteus
UPDATE `creature_template` SET `unit_flags` = `unit_flags` &~ (536870912|262144) WHERE `entry` = 30493;
