...
class TC_GAME_API Unit : public WorldObject
{
    ...
    public:
        ...
        static uint32 SpellCriticalDamageBonus(Unit const* caster, SpellInfo const* spellProto, uint32 damage, bool isPeriodic = false);
        static uint32 SpellCriticalHealingBonus(Unit const* caster, uint32 damage);
        static bool IsReducedPeriodicCritDamageSpell(SpellInfo const* spellInfo);
