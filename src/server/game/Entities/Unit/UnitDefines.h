...
enum UnitFlags2 : uint32
{
    ...
    UNIT_FLAG2_SUPPRESS_HIGHLIGHT_WHEN_TARGETED_OR_MOUSED_OVER      = 0x00080000,   // Suppress highlight when targeted or moused over
    UNIT_FLAG2_TREAT_AS_RAID_UNIT_FOR_HELPFUL_SPELLS                = 0x00100000,   // Treat as Raid Unit For Helpful Spells (Instances ONLY)
    UNIT_FLAG2_LARGE_AOI                                            = 0x00200000,   // Large (AOI)
    UNIT_FLAG2_GIGANTIC_AOI                                         = 0x00400000,   // Gigantic (AOI)
    UNIT_FLAG2_NO_ACTIONS                                           = 0x00800000,
    UNIT_FLAG2_AI_WILL_ONLY_SWIM_IF_TARGET_SWIMS                    = 0x01000000,   // AI will only swim if target swims
