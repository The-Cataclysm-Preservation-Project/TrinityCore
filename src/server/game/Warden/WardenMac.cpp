...
void WardenMac::HandleHashResult(ByteBuffer &buff)
{
    ...
    // Verify key
    //if (memcmp(buff.contents() + 1, Trinity::Crypto::SHA1::GetDigestOf(keyIn).data(), 20) != 0)
    //{
    ...
    // change keys here
    memcpy(_inputKey.data(), keyIn.data(), 16);
