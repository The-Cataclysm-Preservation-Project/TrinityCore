...
enum OpcodeClient : uint16
{
    ...
    CMSG_BATTLEFIELD_JOIN                             = 0x123F, // old 0x0000,
    CMSG_BATTLEFIELD_LEAVE                            = 0x3018,
    CMSG_BATTLEFIELD_LIST                             = 0x3814,
    CMSG_BATTLEFIELD_MGR_ADVANCE_STATE                = 0x14EA, //todo
    CMSG_BATTLEFIELD_MGR_SET_NEXT_TRANSITION_TIME     = 0x14EB, //todo
    CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE        = 0x14E0, //old 0x05A3,
    CMSG_BATTLEFIELD_MGR_EXIT_REQUEST                 = 0x14E8, //old 0x2490,
    CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE        = 0x14E3, //old 0x0413,
    ...
    CMSG_BATTLEMASTER_HELLO                           = 0x12D8, //old 0x0234,
...
enum OpcodeServer
{
    ...
    SMSG_ARENA_TEAM_CHANGE_FAILED_QUEUED              = 0x14C9, //old 0x6E34,
    ...
    SMSG_BATTLEFIELD_MGR_EJECTED                      = 0x14E7, //old 0x7DB7,
    SMSG_BATTLEFIELD_MGR_EJECT_PENDING                = 0x14E6, //old 0x34A2,
    SMSG_BATTLEFIELD_MGR_ENTERED                      = 0x14E1, //old 0x5CA0,
    SMSG_BATTLEFIELD_MGR_ENTRY_INVITE                 = 0x14DF, //old 0x34B3, uint32
    SMSG_BATTLEFIELD_MGR_EXIT_REQUEST                 = 0x51B1,
    SMSG_BATTLEFIELD_MGR_ENTERING                     = 0x14E1, // todo
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                 = 0x14E2, //old 0x15A6,
    SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE       = 0x14E5, //old 0x79B6,
    SMSG_BATTLEFIELD_MGR_STATE_CHANGE                 = 0x14E9, //old 0x35B4,
    ...
    SMSG_BATTLEGROUND_INFO_THROTTLED                  = 0x14A7, //old 0x34B2,
