...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_FORCE_MOVE_ROOT_ACK,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_FORCE_MOVE_UNROOT_ACK,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    ...
    DEFINE_HANDLER(CMSG_MOVE_FEATHER_FALL_ACK,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK,          STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_FORCE_FLIGHT_SPEED_CHANGE_ACK,               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_FORCE_PITCH_RATE_CHANGE_ACK,                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK,             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_FORCE_RUN_SPEED_CHANGE_ACK,                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_FORCE_SWIM_BACK_SPEED_CHANGE_ACK,            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_FORCE_SWIM_SPEED_CHANGE_ACK,                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_FORCE_TURN_RATE_CHANGE_ACK,                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_FORCE_WALK_SPEED_CHANGE_ACK,                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_GRAVITY_DISABLE_ACK,                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_GRAVITY_ENABLE_ACK,                          STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_HOVER_ACK,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_KNOCK_BACK_ACK,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_NOT_ACTIVE_MOVER,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveNotActiveMover        );
    DEFINE_HANDLER(CMSG_MOVE_SET_CAN_FLY,                                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode);
    DEFINE_HANDLER(CMSG_MOVE_SET_CAN_FLY_ACK,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY_ACK, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    DEFINE_HANDLER(CMSG_MOVE_SET_COLLISION_HEIGHT_ACK,                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
    ...
    DEFINE_HANDLER(CMSG_MOVE_WATER_WALK_ACK,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveStateChangeAckOpcode  );
...
#define DEFINE_MSG_OPCODE_HANDLER(opcode, status, processing, handler, con) \
    ...
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_FALL_LAND,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_HEARTBEAT,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_JUMP,                                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_FACING,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_PITCH,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_RUN_MODE,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_WALK_MODE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_ASCEND,                                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_BACKWARD,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_DESCEND,                                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_FORWARD,                                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_PITCH_DOWN,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_PITCH_UP,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_LEFT,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_RIGHT,                           STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_SWIM,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_TURN_LEFT,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_TURN_RIGHT,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP,                                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_ASCEND,                                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_PITCH,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_STRAFE,                                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_SWIM,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_TURN,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleClientAuthorativeMovementOpcode, CONNECTION_TYPE_INSTANCE);
