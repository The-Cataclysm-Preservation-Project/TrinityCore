...
class spell_violet_hold_destroy_door_seal : public SpellScriptLoader
{
    public:
        ...
        class spell_violet_hold_destroy_door_seal_AuraScript : public AuraScript
        {
            ...
            {
                OnEffectPeriodic.Register(this, &spell_violet_hold_destroy_door_seal_AuraScript::PeriodicTick, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
            }
...
class spell_violet_hold_portal_periodic : public SpellScriptLoader
{
    public:
        ...
        class spell_violet_hold_portal_periodic_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectPeriodic.Register(this, &spell_violet_hold_portal_periodic_AuraScript::PeriodicTick, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
            }
        };
...
class spell_violet_hold_teleport_player : public SpellScriptLoader
{
    public:
        ...
        class spell_violet_hold_teleport_player_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_violet_hold_teleport_player_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
