...
class spell_moragg_ray : public SpellScriptLoader
{
    public:
        ...
        class spell_moragg_ray_AuraScript : public AuraScript
        {
            ...
            {
                OnEffectPeriodic.Register(this, &spell_moragg_ray_AuraScript::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
            }
        };
...
public:
    ...
    class spell_moragg_optic_link_AuraScript : public AuraScript
    {
        ...
        void Register() override
        {
            OnEffectPeriodic.Register(this, &spell_moragg_optic_link_AuraScript::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
            OnEffectUpdatePeriodic.Register(this, &spell_moragg_optic_link_AuraScript::OnUpdate, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
        }
    };
