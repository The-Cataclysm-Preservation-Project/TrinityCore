...
class spell_putricide_gaseous_bloat : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_gaseous_bloat_AuraScript : public AuraScript
        {
            ...
            {
                OnEffectPeriodic.Register(this, &spell_putricide_gaseous_bloat_AuraScript::HandleExtraEffect, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
                OnProc.Register(this, &spell_putricide_gaseous_bloat_AuraScript::HandleProc);
            }
        };
...
class spell_putricide_ooze_channel : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_ooze_channel_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect.Register(this, &spell_putricide_ooze_channel_SpellScript::SelectTarget, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
                OnObjectAreaTargetSelect.Register(this, &spell_putricide_ooze_channel_SpellScript::SetTarget, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
                OnObjectAreaTargetSelect.Register(this, &spell_putricide_ooze_channel_SpellScript::SetTarget, EFFECT_2, TARGET_UNIT_SRC_AREA_ENEMY);
                AfterHit.Register(this, &spell_putricide_ooze_channel_SpellScript::StartAttack);
            }
...
class spell_putricide_slime_puddle : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_slime_puddle_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect.Register(this, &spell_putricide_slime_puddle_SpellScript::ScaleRange, EFFECT_0, TARGET_UNIT_DEST_AREA_ENEMY);
                OnObjectAreaTargetSelect.Register(this, &spell_putricide_slime_puddle_SpellScript::ScaleRange, EFFECT_1, TARGET_UNIT_DEST_AREA_ENTRY);
            }
        };
...
class spell_putricide_slime_puddle_aura : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_slime_puddle_aura_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnHit.Register(this, &spell_putricide_slime_puddle_aura_SpellScript::ReplaceAura);
            }
        };
...
class spell_putricide_unstable_experiment : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_unstable_experiment_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_putricide_unstable_experiment_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_putricide_ooze_eruption_searcher : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_ooze_eruption_searcher_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_putricide_ooze_eruption_searcher_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
...
class spell_putricide_ooze_tank_protection : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_ooze_tank_protection_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectProc.Register(this, &spell_putricide_ooze_tank_protection_AuraScript::HandleProc, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL);
                OnEffectProc.Register(this, &spell_putricide_ooze_tank_protection_AuraScript::HandleProc, EFFECT_1, SPELL_AURA_PROC_TRIGGER_SPELL);
            }
        };
...
class spell_putricide_choking_gas_bomb : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_choking_gas_bomb_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_putricide_choking_gas_bomb_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_putricide_unbound_plague : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_unbound_plague_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect.Register(this, &spell_putricide_unbound_plague_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ALLY);
                OnEffectHitTarget.Register(this, &spell_putricide_unbound_plague_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_putricide_eat_ooze : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_eat_ooze_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_putricide_eat_ooze_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
                OnObjectAreaTargetSelect.Register(this, &spell_putricide_eat_ooze_SpellScript::SelectTarget, EFFECT_0, TARGET_UNIT_DEST_AREA_ENTRY);
            }
        };
...
class spell_putricide_mutated_plague : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_mutated_plague_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectPeriodic.Register(this, &spell_putricide_mutated_plague_AuraScript::HandleTriggerSpell, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
                AfterEffectRemove.Register(this, &spell_putricide_mutated_plague_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_putricide_mutation_init : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_mutation_init_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnCheckCast.Register(this, &spell_putricide_mutation_init_SpellScript::CheckRequirement);
            }
        };
        ...
        class spell_putricide_mutation_init_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove.Register(this, &spell_putricide_mutation_init_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_putricide_mutated_transformation_dismiss : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_mutated_transformation_dismiss_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove.Register(this, &spell_putricide_mutated_transformation_dismiss_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_putricide_mutated_transformation : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_mutated_transformation_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHit.Register(this, &spell_putricide_mutated_transformation_SpellScript::HandleSummon, EFFECT_0, SPELL_EFFECT_SUMMON);
            }
        };
...
class spell_putricide_mutated_transformation_dmg : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_mutated_transformation_dmg_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect.Register(this, &spell_putricide_mutated_transformation_dmg_SpellScript::FilterTargetsInitial, EFFECT_0, TARGET_UNIT_SRC_AREA_ALLY);
            }
        };
...
class spell_putricide_regurgitated_ooze : public SpellScriptLoader
{
    public:
        ...
        {            // the only purpose of this hook is to fail the achievement
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_putricide_regurgitated_ooze_SpellScript::ExtraEffect, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };
...
class spell_putricide_clear_aura_effect_value : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_clear_aura_effect_value_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_putricide_clear_aura_effect_value_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_stinky_precious_decimate : public SpellScriptLoader
{
    public:
        ...
        class spell_stinky_precious_decimate_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_stinky_precious_decimate_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
