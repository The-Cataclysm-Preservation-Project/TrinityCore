    ...
    public:
        ...
        class spell_putricide_mutated_plague_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                ...
                AfterEffectRemove.Register(this, &spell_putricide_mutated_plague_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
            }
        };
...
class spell_putricide_mutation_init : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_mutation_init_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove.Register(this, &spell_putricide_mutation_init_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY);
            }
        };
...
class spell_putricide_mutated_transformation_dismiss : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_mutated_transformation_dismiss_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove.Register(this, &spell_putricide_mutated_transformation_dismiss_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
            }
        };
