...
class spell_blood_queen_vampiric_bite : public SpellScriptLoader
{
    public:
        ...
        class spell_blood_queen_vampiric_bite_SpellScript : public SpellScript
        {
            ...
            {
                OnCheckCast.Register(this, &spell_blood_queen_vampiric_bite_SpellScript::CheckTarget);
                BeforeHit.Register(this, &spell_blood_queen_vampiric_bite_SpellScript::OnCast);
                OnEffectHitTarget.Register(this, &spell_blood_queen_vampiric_bite_SpellScript::HandlePresence, EFFECT_1, SPELL_EFFECT_TRIGGER_SPELL);
            }
        };
...
class spell_blood_queen_frenzied_bloodthirst : public SpellScriptLoader
{
    public:
        ...
        class spell_blood_queen_frenzied_bloodthirst_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectApply.Register(this, &spell_blood_queen_frenzied_bloodthirst_AuraScript::OnApply, EFFECT_0, SPELL_AURA_OVERRIDE_SPELLS, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove.Register(this, &spell_blood_queen_frenzied_bloodthirst_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_OVERRIDE_SPELLS, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_blood_queen_bloodbolt : public SpellScriptLoader
{
    public:
        ...
        class spell_blood_queen_bloodbolt_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect.Register(this, &spell_blood_queen_bloodbolt_SpellScript::FilterTargets, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
                OnEffectHitTarget.Register(this, &spell_blood_queen_bloodbolt_SpellScript::HandleScript, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_blood_queen_essence_of_the_blood_queen : public SpellScriptLoader
{
    public:
        ...
        class spell_blood_queen_essence_of_the_blood_queen_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectProc.Register(this, &spell_blood_queen_essence_of_the_blood_queen_AuraScript::OnProc, EFFECT_1, SPELL_AURA_DUMMY);
            }
        };
...
class spell_blood_queen_pact_of_the_darkfallen : public SpellScriptLoader
{
    public:
        ...
        class spell_blood_queen_pact_of_the_darkfallen_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect.Register(this, &spell_blood_queen_pact_of_the_darkfallen_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ALLY);
            }
        };
...
class spell_blood_queen_pact_of_the_darkfallen_dmg : public SpellScriptLoader
{
    public:
        ...
        class spell_blood_queen_pact_of_the_darkfallen_dmg_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectPeriodic.Register(this, &spell_blood_queen_pact_of_the_darkfallen_dmg_AuraScript::PeriodicTick, EFFECT_1, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
            }
        };
...
class spell_blood_queen_pact_of_the_darkfallen_dmg_target : public SpellScriptLoader
{
    public:
        ...
        class spell_blood_queen_pact_of_the_darkfallen_dmg_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect.Register(this, &spell_blood_queen_pact_of_the_darkfallen_dmg_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ALLY);
            }
        };
