...
class spell_festergut_pungent_blight : public SpellScriptLoader
{
    public:
        ...
        class spell_festergut_pungent_blight_SpellScript : public SpellScript
        {
            ...
            {
                OnEffectHitTarget.Register(this, &spell_festergut_pungent_blight_SpellScript::HandleScript, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_festergut_gastric_bloat : public SpellScriptLoader
{
    public:
        ...
        class spell_festergut_gastric_bloat_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_festergut_gastric_bloat_SpellScript::HandleScript, EFFECT_2, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_festergut_blighted_spores : public SpellScriptLoader
{
    public:
        ...
        class spell_festergut_blighted_spores_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectRemove.Register(this, &spell_festergut_blighted_spores_AuraScript::ExtraEffect, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE, AURA_EFFECT_HANDLE_REAL);
            }
        };
