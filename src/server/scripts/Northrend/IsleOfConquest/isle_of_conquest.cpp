...
class spell_ioc_gunship_portal : public SpellScriptLoader
{
    public:
        ...
        class spell_ioc_gunship_portal_SpellScript : public SpellScript
        {
            ...
            {
                OnEffectHitTarget.Register(this, &spell_ioc_gunship_portal_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_ioc_parachute_ic : public SpellScriptLoader
{
    public:
        ...
        class spell_ioc_parachute_ic_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectPeriodic.Register(this, &spell_ioc_parachute_ic_AuraScript::HandleTriggerSpell, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
            }
        };
...
class spell_ioc_launch : public SpellScriptLoader
{
    public:
        ...
        class spell_ioc_launch_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                AfterHit.Register(this, &spell_ioc_launch_SpellScript::Launch);
            }
        };
...
class spell_ioc_seaforium_blast_credit : public SpellScriptLoader
{
    public:
        ...
        class spell_ioc_seaforium_blast_credit_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_ioc_seaforium_blast_credit_SpellScript::HandleAchievementCredit, EFFECT_1, SPELL_EFFECT_GAMEOBJECT_DAMAGE);
            }
        };
