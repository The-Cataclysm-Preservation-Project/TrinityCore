...
class spell_trollgore_consume : public SpellScriptLoader
{
    public:
        ...
        class spell_trollgore_consume_SpellScript : public SpellScript
        {
            ...
            {
                OnEffectHitTarget.Register(this, &spell_trollgore_consume_SpellScript::HandleConsume, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_trollgore_invader_taunt : public SpellScriptLoader
{
    public:
        ...
        class spell_trollgore_invader_taunt_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_trollgore_invader_taunt_SpellScript::HandleTaunt, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
