...
class spell_load_into_catapult : public SpellScriptLoader
{
    ...
    public:
        ...
        class spell_load_into_catapult_AuraScript : public AuraScript
        {
            ...
            {
                OnEffectApply.Register(this, &spell_load_into_catapult_AuraScript::OnApply, EFFECT_0, SPELL_AURA_CONTROL_VEHICLE, AURA_EFFECT_HANDLE_REAL);
                OnEffectRemove.Register(this, &spell_load_into_catapult_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_CONTROL_VEHICLE, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            }
        };
...
class spell_auto_repair : public SpellScriptLoader
{
    ...
    public:
        ...
        class spell_auto_repair_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_auto_repair_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
                BeforeHit.Register(this, &spell_auto_repair_SpellScript::CheckCooldownForTarget);
            }
        };
...
class spell_systems_shutdown : public SpellScriptLoader
{
    public:
        ...
        class spell_systems_shutdown_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectApply.Register(this, &spell_systems_shutdown_AuraScript::OnApply, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN, AURA_EFFECT_HANDLE_REAL);
                OnEffectRemove.Register(this, &spell_systems_shutdown_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_pursue : public SpellScriptLoader
{
        ...
        class spell_pursue_SpellScript : public SpellScript
    {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect.Register(this, &spell_pursue_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
                OnObjectAreaTargetSelect.Register(this, &spell_pursue_SpellScript::FilterTargetsSubsequently, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
            }
...
class spell_vehicle_throw_passenger : public SpellScriptLoader
{
    public:
        ...
        class spell_vehicle_throw_passenger_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_vehicle_throw_passenger_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
