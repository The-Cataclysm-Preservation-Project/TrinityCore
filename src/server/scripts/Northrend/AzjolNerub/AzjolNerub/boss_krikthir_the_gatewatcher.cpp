...
class spell_gatewatcher_subboss_trigger : public SpellScriptLoader
{
    public:
        ...
        class spell_gatewatcher_subboss_trigger_SpellScript : public SpellScript
        {
            ...
            {
                OnObjectAreaTargetSelect.Register(this, &spell_gatewatcher_subboss_trigger_SpellScript::HandleTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
            }
        };
...
class spell_anub_ar_skirmisher_fixate : public SpellScriptLoader
{
    public:
        ...
        class spell_anub_ar_skirmisher_fixate_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget.Register(this, &spell_anub_ar_skirmisher_fixate_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
