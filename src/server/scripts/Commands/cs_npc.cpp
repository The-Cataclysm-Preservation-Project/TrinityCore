...
EnumName<UnitFlags> const unitFlags[MAX_UNIT_FLAGS] =
{
    ...
    CREATE_NAMED_ENUM(UNIT_FLAG_PVP_ENABLING),
    ...
    CREATE_NAMED_ENUM(UNIT_FLAG_PREVENT_EMOTES_FROM_CHAT_TEXT),
...
EnumName<UnitFlags2> const unitFlags2[MAX_UNIT_FLAGS2] =
{
    ...
    CREATE_NAMED_ENUM(UNIT_FLAG2_DONT_FADE_IN),
    ...
    CREATE_NAMED_ENUM(UNIT_FLAG2_ALLOW_CHANGING_TALENTS),
    ...
    CREATE_NAMED_ENUM(UNIT_FLAG2_INTERACT_WHILE_HOSTILE),
    CREATE_NAMED_ENUM(UNIT_FLAG2_CANNOT_TURN),
    ...
    CREATE_NAMED_ENUM(UNIT_FLAG2_SUPPRESS_HIGHLIGHT_WHEN_TARGETED_OR_MOUSED_OVER),
    CREATE_NAMED_ENUM(UNIT_FLAG2_TREAT_AS_RAID_UNIT_FOR_HELPFUL_SPELLS),
    CREATE_NAMED_ENUM(UNIT_FLAG2_LARGE_AOI),
    CREATE_NAMED_ENUM(UNIT_FLAG2_GIGANTIC_AOI),
    CREATE_NAMED_ENUM(UNIT_FLAG2_NO_ACTIONS),
    CREATE_NAMED_ENUM(UNIT_FLAG2_AI_WILL_ONLY_SWIM_IF_TARGET_SWIMS),
    CREATE_NAMED_ENUM(UNIT_FLAG2_DONT_GENERATE_COMBAT_LOG_WHEN_ENGAGED_WITH_NPCS),
    CREATE_NAMED_ENUM(UNIT_FLAG2_UNTARGETABLE_BY_CLIENT),
    CREATE_NAMED_ENUM(UNIT_FLAG2_ATTACKER_IGNORES_MINIMUM_RANGES),
    CREATE_NAMED_ENUM(UNIT_FLAG2_UNINTERACTIBLE_IF_HOSTILE),
    CREATE_NAMED_ENUM(UNIT_FLAG2_UNUSED_11),
    CREATE_NAMED_ENUM(UNIT_FLAG2_INFINITE_AOI),
    CREATE_NAMED_ENUM(UNIT_FLAG2_UNUSED_13)
};
...
EnumName<CreatureFlagsExtra> const flagsExtra[] =
{
    ...
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_UNUSED_9),
    ...
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_UNUSED_13),
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_WORLDEVENT),
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_GUARD),
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_IGNORE_FEIGN_DEATH),
    ...
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_UNUSED_22),
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_UNUSED_23),
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_UNUSED_24),
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_UNUSED_25),
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_UNUSED_26),
