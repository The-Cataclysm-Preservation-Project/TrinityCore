...
void WorldDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(WORLD_SEL_SMARTAI_WP, "SELECT entry, pointid, position_x, position_y, position_z, velocity FROM waypoints ORDER BY entry, pointid", CONNECTION_SYNCH);
